...
BMW = Car("CAR001", 100.00, 4)
Appache = Bike("BIKE001", 80.00, "Supermoto")

print(BMW.display_details())  
print("Car Rental Charge:", calculate_rental(BMW))  

print(Appache.display_details()) 
print("Bike Rental Charge:", calculate_rental(Appache)) 
